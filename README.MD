...
- Integrate **multi-city itinerary generation**  
- Add **cost estimation and optimization** features  
- Support **map visualization** using Folium or Google Maps API  
- Deploy as a **cloud-based agent** on Azure/AWS  
